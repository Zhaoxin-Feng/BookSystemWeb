...
<head>
 ...
 $(function () {
      ...
      $('#next_question').click(function () {
        ...
        if (n == 1 && right == 0) { //答题结束
          alert('您识字量测试的得分是：'+0);
          window.location.href="select_test.php?part1="+0;
        } else if (n == 15 && right == 1) {
          alert('您识字量测试的得分是：'+n);
          window.location.href="select_test.php?part1="+n;
          ...
          alert('您识字量测试的得分是：'+max);
          window.location.href="select_test.php?part1="+max;
        } else {
      ...
      function load_question() { //显示题目
        ...
        $.ajax({
          ...
          // 换图片（选项）
          $("#answerA").attr('src','imgs/test_img/1-'+n+'-A.jpg');
          $("#answerB").attr('src','imgs/test_img/1-'+n+'-B.jpg');
          $("#answerC").attr('src','imgs/test_img/1-'+n+'-C.jpg');
...
<body>
  ...
  <div class="question1">
    ...
    <br />
    <br />
    <p id="question">1、你能把汉字和图片匹配上吗？</p>
    <table class="answer1">
      ...
      <tr align="center" width="100%">
        <td><img id="answerA" src="imgs/test_img/1-1-A.jpg" width="80%" style="border-radius: 2em;"/></td>
        <td><img id="answerB" src="imgs/test_img/1-1-B.jpg" width="80%" style="border-radius: 2em;"/></td>
        <td><img id="answerC" src="imgs/test_img/1-1-C.jpg" width="80%" style="border-radius: 2em;"/></td>
        <td>不知道</td>
      </tr>
    </table>
  </div>
